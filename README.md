...
This is a homework for Chili Labs by Ruslan Rezanov.

## Contribution

For folder architecture I've used [Bulletproof React](https://github.com/alan2207/bulletproof-react/blob/master/docs/project-structure.md).
...
2. Check node and npm using `node -v` or `npm -v`.
